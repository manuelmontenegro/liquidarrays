...
class MusTest {
    private val goalG1 = Z3Goal(
            ...
            listOf(
                    ...
                    PredicateApplication("=", listOf(Variable("n1"), FunctionApplication("+", listOf(Variable("n"), Literal("1", intType))), Variable("a_len")))
            ),
            PredicateApplication("mu1", listOf(Variable("a"), Variable("n1"), Variable("a_len"))),
            mapOf("a" to ConstrType("array", listOf(intType)), "n" to intType, "n1" to intType, "a_len" to intType),
            mapOf(),
            mapOf(
                    "mu1" to Mu("mu1",
    ...
    private val goalG2 = Z3Goal(
            ...
            PredicateApplication("mu1", listOf(Variable("a"), Variable("n1"), Variable("a_len"))),
            mapOf("a" to ConstrType("array", listOf(intType)), "n" to intType, "n1" to intType, "k" to intType, "a_len" to intType),
            mapOf(),
            mapOf("mu1" to Mu(
                    "mu1",
    ...
    private val auxG6 = { qii: List<Assertion> ->
        Z3Goal("G6",
                "Goal for testing",
                listOf(
                        PredicateApplication(">=", listOf(Variable("a_len"), Literal("0", intType))),
